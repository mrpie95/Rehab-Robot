...
class elephantGesture {

	public:


  void elephantHeadAnimation(AL::ALMotionProxy motion)
          {
    ...
    motion.angleInterpolation(jointName, targetAngles, targetTimes, isAbsolute);
          ...
          void elephantArmAnimation(AL::ALMotionProxy motion)
          {
          ...
          void elephantShoulderLeftLegAnimation(AL::ALMotionProxy motion)
          {
          ...
          */
          ...
          void elephantRightLegAnimation(AL::ALMotionProxy motion)
          {
